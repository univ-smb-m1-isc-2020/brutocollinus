...
public class MeController {
    ...
    @ResponseBody
    public CollectionModel<BrutoResponse> allBruto(@PathVariable String uuid) {
    ...
    public CollectionModel<TournamentResponse> allTournamentInProgress(@PathVariable String uuid) {
        ...
        return CollectionModel.of(myActiveTournaments.stream()
    ...
    @ResponseBody
    public CollectionModel<LastOverMatchResponse> allLastOverMatch(@PathVariable String uuid) {
        Player me = this.playerService.get(uuid);
        return CollectionModel.of(this.lastOverMatchService.findAllByParticipant(me).stream()
                .map(LastOverMatchResponse::new)
                .collect(Collectors.toList()));
    }
